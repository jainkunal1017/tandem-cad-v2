      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="relative flex justify-center items-center py-16">
          ...
          <div className="absolute z-10 bg-background rounded-full p-6 shadow-lg">
            <img src="/lovable-uploads/89d84111-7606-492c-9784-5785924d0f35.png" alt="Tandem Symbol" className="h-16 w-16" />
          </div>
          
          {/* Integration logos */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-16 w-full">
            {integrations.map((integration, index) => <div key={index} className="flex flex-col items-center" onMouseEnter={() => setFocusedIndex(index)} onMouseLeave={() => setFocusedIndex(null)}>
                <div className={`
